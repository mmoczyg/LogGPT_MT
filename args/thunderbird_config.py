...
def get_args():
    ...
    parser.add_argument('--dataset_name', default='Thunderbird', type=str,
                        help='The name of the dataset to be parsed (default: TB)')
    parser.add_argument('--output_dir', default='./datasets/', type=str,
                        help='The output directory of parsing results')
    parser.add_argument('--seed', default=3, type=int, help='random seed (default: 3)')
